...
if ( $nodelogic_graph_builder_slider_id === '' ) {
    $nodelogic_graph_builder_slider_id = wp_unique_id( 'number_' );
}
...
?>
<div class="slider-container slider-container--field" id="<?php echo esc_attr($nodelogic_graph_builder_slider_id); ?>" data-slider-id="<?php echo esc_attr($nodelogic_graph_builder_slider_id); ?>"<?php echo $style_attr !== '' ? ' style="' . esc_attr($style_attr) . '"' : ''; ?>>
    <input
